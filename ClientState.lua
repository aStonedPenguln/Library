...
local client_state = require "client_state"

callbacks.Register(
    "Draw",
    function()
        print(("choked commands:\x20%d"):format(client_state.chokedcommands()))
        print(("command ack:\x20%d"):format(client_state.commandack()))
        print(("last command ack:\x20%d"):format(client_state.lastcommandack()))
        print(("last out going command:\x20%d"):format(client_state.lastoutgoingcommand()))
        print(("last server tick:\x20%d"):format(client_state.lastservertick()))
    end
)
